...
export const allNewsItems: NewsItem[] = [
  ...
  },
  {
    ...
    excerpt: "Prof. Kim Oanh, Director of AirQC, was interviewed by the Vietnamese National TV channel (VTV1). <br></br>She discussed the importance of obtaining accurate emission data from different source sectors.<br></br>The full interview video can be found at<br><a href='https://www.youtube.com/watch?v=Sl-bWb8xQIU' style='color: hsl(105 33% 30%); text-decoration: underline;'>https://www.youtube.com/watch?v=Sl-bWb8xQIU</a>",
    category: "Media",
    date: "22 April 2025",
    image: m5,
