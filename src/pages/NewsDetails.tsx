  ...
  const newsItems: NewsItem[] = [
    {
      ...
      content: "Our comprehensive three-year study has revealed alarming insights into how rice straw burning practices across Southeast Asia significantly contribute to regional air pollution. The research, conducted in collaboration with international partners, analyzed satellite data, ground-level measurements, and economic impacts across six countries.\n\nThe study found that during peak burning seasons, particulate matter (PM<sub>2.5</sub>) concentrations increased by up to 300% in affected regions, with health implications extending far beyond agricultural areas. These findings highlight the urgent need for alternative agricultural practices and coordinated regional policy responses.\n\nKey findings include: seasonal PM<sub>2.5</sub> spikes correlating with burning periods, transboundary pollution affecting neighboring countries, economic losses from health impacts exceeding $2.3 billion annually, and successful pilot programs demonstrating viable alternatives to open burning.\n\nThe research team recommends implementing comprehensive regional frameworks for agricultural waste management, providing economic incentives for farmers to adopt alternative practices, and establishing real-time monitoring networks to track pollution sources and impacts.",
      category: "Research",
      date: "2025-08-10",
